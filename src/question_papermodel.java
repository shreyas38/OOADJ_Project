...
public class question_papermodel {
    ...
    public static void enter_question_paper_details(){
        ...
        try  {
            ...
            String ins = "INSERT INTO question_paper VALUES ('" + stud.coursecode + "','"+ stud.coursename + "','"+ stud.mcq_question + "','" + stud.short_question + "','"+ stud.long_question + "','" + stud.marks + "','" + stud.department +"')";
