...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do{
            ...
            option= reader.readLine();//sc.nextLine();
            switch(option){
                case "1": //Admin
                ...
                do{
                    ...
                    switch(adop1){
                        ...
                        ad.adminid= reader.readLine();//sc.nextLine(); //reads String
                        System.out.println("Enter Admin Password:");
                        ad.adminPassword= reader.readLine();//sc.nextLine(); //reads String
                ...
                do{
                    ...
                    switch(op1){
                        ...
                        teach.teacherid= sc.nextLine(); //reads String
                        System.out.println("Enter Teacher Password:");
                        teach.teacherPassword= sc.nextLine(); //reads String
